...
public class AdminAccountPage3  extends AppCompatActivity {
    WebView webView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_account_page3);
    ...
    public void onModifyClick(View v) {
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(AdminAccountPage3.this);
        ...
        dialog.getButton(AlertDialog.BUTTON_POSITIVE).setOnClickListener((v1 -> {
            EditText edat = (EditText)findViewById(R.id.editTextTextPersonName4);
            EditText edpd = (EditText)findViewById(R.id.editTextTextPassword5);
    ...
    private void setToast (String text){
        Toast.makeText(AdminAccountPage3.this, text, Toast.LENGTH_SHORT).show();
    }
