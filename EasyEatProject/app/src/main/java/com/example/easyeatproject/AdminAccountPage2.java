...
public class AdminAccountPage2 extends AppCompatActivity {
    WebView webView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_account_page2);
    ...
    public void onModifyClick(View v) {
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(AdminAccountPage2.this);
        ...
        dialog.getButton(AlertDialog.BUTTON_POSITIVE).setOnClickListener((v1 -> {
            EditText edat = (EditText)findViewById(R.id.editTextTextPersonName3);
            EditText edpd = (EditText)findViewById(R.id.editTextTextPassword4);
    ...
    private void setToast (String text){
        Toast.makeText(AdminAccountPage2.this, text, Toast.LENGTH_SHORT).show();
    }
