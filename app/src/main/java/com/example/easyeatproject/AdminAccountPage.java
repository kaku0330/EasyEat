...
public class AdminAccountPage extends AppCompatActivity {
    ...
    public void onModifyClick(View v) {
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(AdminAccountPage.this);
        ...
        dialog.getButton(AlertDialog.BUTTON_POSITIVE).setOnClickListener((v1 -> {
            ...
            EditText edat = (EditText)findViewById(R.id.editTextTextPersonName);
            EditText edpd = (EditText)findViewById(R.id.editTextTextPassword2);
            MySQL.updatedata("Account","password", String.valueOf(edpd.getText()),"account",String.valueOf(edat.getText()),cookieStr,url);
    ...
    private void setToast (String text){
        Toast.makeText(AdminAccountPage.this, text, Toast.LENGTH_SHORT).show();
    }
